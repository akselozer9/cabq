...
fs2.readFile('./ACCOUNTBUILDINGS/electricACCOUNTSsorted.json', 'utf8', (err, data) => {
    if (err) {
        console.log(`can't read water2022.json`)
    }
...
fs3.writeFileSync('./tempResults/ElectricResults.json', JSON.stringify(modifiedJsonFile));
})
})